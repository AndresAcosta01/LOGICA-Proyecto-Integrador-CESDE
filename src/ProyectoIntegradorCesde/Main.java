...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        nombresUsuarios[1] = "Andrea";
        emailsUsuarios[1] = "andrea@gmail.com";
        contraseniasUsuarios[1] = "andrea123";
        rolesUsuarios[0] = "Cliente";
        nombresUsuarios[1] = "2";
        emailsUsuarios[1] = "2";
